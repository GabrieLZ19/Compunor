...
export default function Home() {
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gamer-dark">
      ...
      <section className="relative py-12 md:py-16 bg-gamer-red dark:bg-gamer-neon">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="inline-block mb-3 px-4 py-2 bg-white/30 backdrop-blur-sm rounded-full text-white font-bold text-sm uppercase tracking-wider">
            Ofertas Exclusivas
          </div>
          ...
          <Link
            href="/catalogo"
            className="inline-flex items-center gap-2 px-6 py-3 bg-white text-gamer-red dark:text-gamer-neon font-bold rounded-lg hover:scale-105 transition-transform"
          >
            Ver Productos
      ...
      {/* Gaming Experience Section - Simplified, no heavy gradients */}
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors">
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-lg bg-gamer-red/20 text-gamer-red mb-4">
            ...
            {/* Card 2 */}
            <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors">
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-lg bg-purple-600/20 text-purple-400 mb-4">
            ...
            {/* Card 3 */}
            <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors">
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-lg bg-cyan-600/20 text-cyan-400 mb-4">
                <Headphones size={28} aria-hidden="true" />
              </div>
              <h3 className="text-xl font-bold mb-2">Asesoramiento Pro</h3>
              <p className="text-gray-400">
      ...
      <section className="py-16 bg-gray-100 dark:bg-black/40">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/catalogo"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gamer-red dark:bg-gamer-neon text-white dark:text-black font-bold rounded-lg hover:opacity-90 transition-opacity"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-green-600 text-white font-bold rounded-lg hover:opacity-90 transition-opacity"
